...
This is an embeddable registration form for the Yale SOM Career Development
...
Serve the delivered folder (or `dist-embed/` after `pnpm install && pnpm pack:embed`) with
